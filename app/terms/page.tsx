...
const sections = [
  ...
  { icon: '⚠️', title: 'Limitation of Liability', items: ['Data loss', 'Business interruption', 'Damages resulting from use of this website'], note: 'Use this website at your own risk.' },
      ...
      <section className="py-12">
        <div className="container-custom">
          <ScrollReveal direction="up" duration={0.2}>
            <div className="mx-auto max-w-2xl rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 mb-5">
              <p className="text-sm text-gray-600 dark:text-gray-300">By accessing HASIF, you agree to comply with these Terms of Service.</p>
            </div>
          </ScrollReveal>
            ...
            {sections.map((section, i) => (
              <ScrollReveal key={section.title} direction="up" delay={i * 0.04} duration={0.2}>
                <div className="group rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 transition-all duration-150 hover:shadow-xl hover:shadow-indigo-500/5 hover:-translate-y-0.5 hover:border-indigo-200 dark:hover:border-indigo-800 overflow-hidden">
                  ...
                  {section.note && <p className="mt-3 ml-14 text-sm font-bold text-indigo-600 dark:text-indigo-400">{section.note}</p>}
